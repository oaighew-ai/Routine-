...
CANDIDATE = Schema("candidates", (
    ...
    Field("specHash", (str,)),
    Field("modelId", (str,), required=False),
    Field("modelVersion", (str,), required=False),
    Field("modelSha256", (str,), required=False),
    Field("protocol", (str,), required=False),
    Field("captureId", (str,), required=False),
